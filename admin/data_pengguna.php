		...
		while($d = mysqli_fetch_array($data)){
			?>
                            <tr>
                                ...
                                <td align="center"><?php echo $d['nama_petugas']; ?></td>
                                <td align="center"><?php echo $d['username']; ?></td>
                                <td align="center"><?php echo $d['level']; ?></td>
                                <td align="center">
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#hapus-data<?php echo $d['id_user']; ?>">
                                    <i class="fa fa-trash fa-fw"></i>
                                    hapus
                                    </button>
                                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#edit-data<?php echo $d['id_user']; ?>">
      ...
      <form action="proses_update_pengguna.php" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_petugas" class=
                        "form-control" value="<?php echo $d['nama_petugas']; ?>">
                    </div>
                    <div class="form-group">
                        <label>Username</label>
                        <input type="text" name="username" class=
                        "form-control" value="<?php echo $d['username']; ?>">
                    </div>
                    <div class="form-group">
                        <label>Level</label>
...
<?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="proses_simpan_pengguna.php" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama Petugas</label>
